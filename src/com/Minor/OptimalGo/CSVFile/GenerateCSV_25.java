...
public class GenerateCSV_25
{
    ...
    public static void main(String[] args) {
        ...
        String[] cities = {"Chennai", "Bangalore", "Dehradun", "Mumbai", "Hyderabad", "Delhi", "Pune", "Kolkata", "Lucknow", "Jaipur","Amritsar", "Ahmedabad", "Indore", "Surat","Chandigarh","Bhopal","Patna","Nagpur","Agra","Kashmir","Goa","Mysore","Varanasi","Shimla","Udaipur"};
        ...
        String[] longDistanceCities = {"Chennai", "Bangalore", "Mumbai", "Delhi", "Hyderabad","Indore","Surat","Bhopal","Patna","Nagpur","Kashmir","Goa","Mysore","Udaipur"};
        String[] shortDistanceCities = {"Pune", "Kolkata", "Lucknow", "Jaipur", "Dehradun","Amritsar","Ahmedabad","Chandigarh","Agra","Varanasi","shimla"};
        ...
        cityAttractions.put("Bhopal", "Upper Lake,Bhimbetka Rock Shelters");
        cityAttractions.put("Kashmir", "Pahalgam ,Dal Lake");
        cityAttractions.put("Patna", "Golghar,Nalanda University");
        cityAttractions.put("Nagpur", "Deekshabhoomi,Ambazari Lake");
        cityAttractions.put("Agra", "Taj Mahal,Agra Fort");
        cityAttractions.put("Goa", "Baga Beach,Fort Aguada");
        cityAttractions.put("Mysore", "Mysore Palace,Brindavan Gardens");
        cityAttractions.put("Varanasi", "Kashi Vishwanath Temple,Dashashwamedh Ghat");
        cityAttractions.put("Shimla", "Mall Road,Jakhoo Temple");
        cityAttractions.put("Udaipur", "City Palace,Lake Pichola");
