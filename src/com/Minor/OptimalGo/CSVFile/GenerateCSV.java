...
public class GenerateCSV {
    public static void main(String[] args) {
        ...
        String[] cities = {"Chennai", "Bangalore", "Dehradun", "Mumbai", "Hyderabad", "Delhi", "Pune", "Kolkata", "Lucknow", "Jaipur"};
        ...
        String[] longDistanceCities = {"Chennai", "Bangalore", "Mumbai", "Delhi", "Hyderabad"};
        String[] shortDistanceCities = {"Pune", "Kolkata", "Lucknow", "Jaipur", "Dehradun"};
