...
public class GenerateCSV_20
{
    ...
    public static void main(String[] args) {
        ...
        String[] cities = {"Chennai", "Bangalore", "Dehradun", "Mumbai", "Hyderabad", "Delhi", "Pune", "Kolkata", "Lucknow", "Jaipur","Amritsar", "Ahmedabad", "Indore", "Surat","Chandigarh","Bhopal","Patna","Nagpur","Agra","Kashmir"};
        ...
        String[] longDistanceCities = {"Chennai", "Bangalore", "Mumbai", "Delhi", "Hyderabad","Indore","Surat","Bhopal","Patna","Nagpur","Kashmir"};
        String[] shortDistanceCities = {"Pune", "Kolkata", "Lucknow", "Jaipur", "Dehradun","Amritsar","Ahmedabad","Chandigarh","Agra"};
